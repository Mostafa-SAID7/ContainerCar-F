...
export const businesses: Business[] = [
  {
    ...
    setupSections: [
      ...
      {
        title: "Branding",
        items: ["Exterior wrap", "Menu board", "Illuminated signage", "Staff uniforms"],
      },
      {
        title: "Launch",
        items: [
    ...
    equipment: [
      {
        name: "Espresso machine (2 group)",
        quantity: 1,
        price: 26000,
        supplierId: "cairo-coffee-equipment",
        included: true,
      },
      {
        name: "Coffee grinder",
      ...
      },
      {
        ...
        quantity: 1,
        price: 9000,
        supplierId: "delta-cooling",
        included: true,
      },
      {
        name: "Water tank (120L)",
        quantity: 1,
        price: 2500,
        supplierId: "mobile-unit-builders",
        included: true,
      },
      {
        name: "Sink unit",
  ...
  },
  {
    ...
    setupSections: [
      ...
      {
        title: "Equipment",
        items: ["Flat-top grill", "Deep fryer", "Freezer + chiller", "Generator 8kVA"],
      },
      { title: "Branding", items: ["Exterior wrap", "Backlit menu board", "Signage", "Uniforms"] },
      {
        title: "Launch",
        items: ["Opening inventory", "Packaging", "Kitchen training", "Food safety onboarding"],
      },
    ],
    equipment: [
      {
        ...
        quantity: 1,
        price: 28000,
        supplierId: "masr-kitchen-co",
        included: true,
      },
      {
        name: "Double deep fryer",
        quantity: 1,
        price: 18000,
        supplierId: "masr-kitchen-co",
        included: true,
  ...
  },
  {
    ...
    setupSections: [
      ...
      {
        title: "Equipment",
        items: ["High-pressure washer", "Vacuum system", "Water recovery mat", "Generator 3kVA"],
      },
      { title: "Branding", items: ["Vehicle wrap", "Service price board", "Uniforms"] },
      {
        title: "Launch",
        items: ["Chemicals and detailing supplies", "Technician training", "Booking setup"],
      },
    ],
    equipment: [
      {
    ...
    staff: {
      roles: [{ role: "Wash technician", count: 2 }],
  ...
  },
  {
    ...
    setupSections: [
      {
        title: "Vehicle",
        items: ["2.5m container unit", "Washable interior", "Service window", "Electrical panel"],
      },
      {
        title: "Equipment",
        items: ["Commercial juicers", "Blenders", "Display chiller", "Generator 4kVA"],
      },
      { title: "Branding", items: ["Exterior wrap", "Menu board", "Uniforms"] },
      {
        title: "Launch",
        items: ["Opening fruit inventory", "Cups and packaging", "Team training"],
      },
    ],
    equipment: [
      {
        name: "Commercial citrus juicer",
        quantity: 2,
        price: 7000,
        supplierId: "masr-kitchen-co",
        included: true,
  ...
  },
  {
    ...
    setupSections: [
      ...
      {
        title: "Equipment",
        items: ["Stone gas oven", "Dough chiller", "Prep counter", "Generator 6kVA"],
      },
    ...
    equipment: [
      ...
      {
        name: "Refrigerated prep counter",
        quantity: 1,
        price: 18000,
        supplierId: "delta-cooling",
        included: true,
  ...
  },
  {
    ...
    setupSections: [
      {
        title: "Vehicle",
        items: ["2.5m container unit", "Climate control", "Mirror wall", "Electrical panel"],
      },
      {
        title: "Equipment",
        items: ["Barber chairs", "Wash basin", "Water heater", "Generator 3kVA"],
      },
